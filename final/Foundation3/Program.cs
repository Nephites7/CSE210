class EventManager
{
    static void Main()
    {
        ...
        LectureEvent lectureEvent = new LectureEvent("Tech Talk", "An informative tech lecture.", DateTime.Now.Date, DateTime.Now.TimeOfDay, eventAddress, "John Doe", 50);
        ...
        ReceptionEvent receptionEvent = new ReceptionEvent("Networking Mixer", "A casual networking event.", DateTime.Now.Date, DateTime.Now.TimeOfDay, eventAddress, "rsvp@example.com");
        ...
        OutdoorGatheringEvent outdoorEvent = new OutdoorGatheringEvent("Picnic in the Park", "Enjoy a day outdoors.", DateTime.Now.Date, DateTime.Now.TimeOfDay, eventAddress, "Sunny");
